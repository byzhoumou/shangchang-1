...
// 文章列表查询参数               这里的&是交叉类型 相当于这个KnowledgeParams 里面有上面PageParams 和自己的所有类型这里是3个都有
...
// Required<T> 转换为全部必须   Partial<T> 转换问全部可选  两个内置的泛型类型
...
// 病情描述对象       pick从PartialConsult类型中挑选出下面4个类型创建新的Consultllness类型
